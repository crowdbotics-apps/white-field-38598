"""
Django settings for white_field_38598 project.
...
ROOT_URLCONF = 'white_field_38598.urls'
...
WSGI_APPLICATION = 'white_field_38598.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "white_field_38598 API",
    "DESCRIPTION": "API documentation for white_field_38598 App",
    "VERSION": "v1",
}
